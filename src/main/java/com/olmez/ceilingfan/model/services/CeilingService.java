...
public interface CeilingService {
    ...
    /**
     * This allows increasing the fan speed by one phase. If the fan speed is 3 {@link FanPhase.HIGH}, the fan is turned off.
     * @param fan
     * @return {@link CeilingFan} with updated speed.
     */
    CeilingFan changeFanSpeed(CeilingFan fan);

    /**
     * This allows changing the fan direction ({@link FanDirection.CLOCKWISE} or {@link FanDirection.COUNTER_CLOCKWISE}).
     * @param fan
